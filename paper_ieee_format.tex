...
\and
\IEEEauthorblockN{Adrian Wood}
\IEEEauthorblockA{\textit{Security Engineer} \\
\textit{Dropbox}\\
adrianw@dropbox.com}
\and
\IEEEauthorblockN{Ammar Al-Khafa}
\IEEEauthorblockA{\textit{Security Engineer} \\
\textit{AWS}\\
adrianw@dropbox.com}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Section: Replication Study – Single‑Agent vs. Multi‑Agent LLMs for an
...
\midrule
Homogeneous--GPT\-4.5          & 70.83\% & 0.005 & 18.65\% & \$10.0\\
Single\-Agent (gpt\-4o\-mini)  & 70.83\% & 0.005 & 18.06\% & \$10.0\\
Single\-Agent (gpt\-4.1\-nano) & 70.83\% & 0.005 & 17.86\% & \$10.0\\
...
\textbf{System} & \textbf{Accuracy} & \textbf{Coverage/Req} & \textbf{Interp Acc} & \textbf{Avg.\ Cost}\\
\midrule
Homogeneous--GPT\-4.5          & 75.00\% & 0.004 & 14.68\% & \$10.0\\
Single\-Agent (gpt\-4o\-mini)   & 70.83\% & 0.004 & 14.68\% & \$10.0\\
Single\-Agent (gpt\-4.1\-nano)  & 50.00\% & 0.004 & 13.48\% & \$10.0\\
...
\textbf{System} & \textbf{Accuracy} & \textbf{Coverage/Req} & \textbf{Interp Acc} & \textbf{Avg.\ Cost}\\
\midrule
Homogeneous--GPT\-4.5           & 66.67\% & 0.005 & 16.27\% & \$10.0\\
Single\-Agent (gpt\-4o\-mini)    & 54.17\% & 0.005 & 16.67\% & \$10.0\\
Single\-Agent (gpt\-4.1\-nano)   & 47.83\% & 0.005 & 15.53\% & \$9.6\\
